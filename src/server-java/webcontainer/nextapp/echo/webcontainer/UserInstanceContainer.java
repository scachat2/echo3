...
/**
 * Container / manager of all <code>UserInstance</code> objects in the servlet
 * session.
 */
public class UserInstanceContainer
     ...
     * client <code>Connection</code>. The instance will automatically be stored
     * in the relevant <code>HttpSession</code>
     *
    ...
    /**
     * Mapping between client-generated unique browser window identifiers and
     * <code>UserInstance</code> values.
     */
    private Map clientWindowIdToUserInstance = new HashMap();

    /**
     * Mapping between <code>UserInstance</code> identifiers and
     * <code>UserInstance</code> values.
     */
    private Map idToUserInstance = new HashMap();

    /**
     * Mapping between initial request identifiers (as returned by
     * <code>createInitId()</code>) and maps of initial requested parameters
     * retrieved from <code>HttpServletRequest.getParameterMap()</code>.
     */
    ...
    /**
     * Creates an initial request identifier. Stores request parameters provided
     * by the connection, such that they may be assigned to the later-generated
     * <code>UserInstance</code> if required.
     *
    ...
    /**
     * Creates or retrieves a <code>UserInstance</code> for the specified client
     * window identifier and initial request identifier. Invoked when a window
     * is loaded for the first time or reloaded.
     *
     * If a <code>UserInstance</code> exists for the specified
     * <code>clientWindowId</code>, it is returned.
     *
     * If a <code>UserInstance</code> does not exist for the specified
     * <code>clientWindowId</code>, one is created and stored within this
     * <code>UserInstanceContainer</code>. The initial request parameters are
     * retrieved from the initialization-id-to-request-parameter-map and stored
     * in the created <code>UserInstance</code>.
     *
     * @param clientWindowId the client-generated unique browser window
     * identifier
     * @param initId the server-generated (by <code>createInitId()</code>)
     * unique initialization request identifier
    ...
    /**
     * Unloads a <code>UserInstance</code> from the container. Disposes of the
     * instance.
     *
    ...
    /**
     * Retrieves an existing <code>UserInstance</code> by its assigned user
     * instance identifier.
     *
     * @param id the <code>UserInstance</code> identifier, i.e., value which
     * would be returned by the <code>UserInstance</code>'s <code>getId()</code>
     * method
     ...
     * @param userInstanceId the user instance id
     * @return the URI
     */
     ...
     *
     * Recreates reference to session. Notifies <code>ApplicationInstance</code>
     * of activation.
     */
     ...
     *
     * Notifies <code>ApplicationInstance</code> of passivation. Discards
    ...
    /**
     * Listener implementation of <code>HttpSessionBindingListener</code>.
     * Disposes <code>ApplicationInstance</code>. Removes reference to session
     * when invoked.
     *
     * @see
